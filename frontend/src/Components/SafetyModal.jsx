                        ...
                        <div className="bg-gray-900 text-gray-100 rounded-2xl shadow-lg p-6">
                            ...
                            <div className="mt-6 flex items-center justify-between">
                                <label className="flex items-center gap-2 text-sm cursor-pointer select-none">
                                    ...
                                    />
                                    <span
                                        className="w-5 h-5 flex items-center justify-center rounded-md border border-gray-400 peer-checked:border-gray-200 
                  peer-checked:bg-gray-200 transition-all"
                                    >
                                        <svg
